        ...
        <div className="min-h-screen bg-white text-slate-900">
            ...
            <section className="px-6 py-24 md:py-32 text-center max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Button size="lg" onClick={() => router.push(isAuthenticated ? '/veterinarians' : '/register')} className="px-8">
                        Book an Appointment
                    </Button>
                    <Button size="lg" variant="outline" onClick={() => router.push('/veterinarians')} className="px-8">
            ...
            <section className="px-6 py-20 text-center">
                <div className="max-w-2xl mx-auto">
                    ...
                    <Button size="lg" onClick={() => router.push(isAuthenticated ? '/veterinarians' : '/register')} className="px-10">
                        Get Started
                    </Button>
                </div>
            </section>
            ...
            <footer className="border-t border-slate-100 px-6 py-10">
                <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex gap-6 text-sm text-slate-500">
                        <button onClick={() => router.push('/veterinarians')} className="hover:text-slate-900 transition-colors">
                            Veterinarians
                        </button>
                        <button onClick={() => router.push('/register')} className="hover:text-slate-900 transition-colors">
                            Register
                        </button>
                        <button onClick={() => router.push('/login')} className="hover:text-slate-900 transition-colors">
                            Login
                        </button>
                    </div>
                </div>
